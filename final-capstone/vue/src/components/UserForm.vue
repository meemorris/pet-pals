        ...
        userService
          ...
          .catch((error) => {
            if (error.response) {
              ...
              alert("Profile could not be created. Server could not be reached");
            } else {
              alert(
        ...
        userService
          ...
          .catch((error) => {
            if (error.response) {
              ...
              alert("Profile could not be updated. Server could not be reached");
            } else {
              alert("Profile could not be updated. Request could not be created.");
            }
          });
      }
    },
